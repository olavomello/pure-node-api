...
app.renewToken = (callback) => {
  ...
  if(sessionToken) {
    ...
    app.client.request('/api/login', 'PUT', undefined, payload, (statusCode, responsePayload) => {
      if(statusCode == 200) {
        ...
        app.client.request('/api/login', 'GET', queryStringObject ,undefined, (statusCode, responsePayload) => {
          if(statusCode == 200) {
            app.setSessionToken(responsePayload);
            callback(false);
          } else {
